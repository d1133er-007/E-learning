...
const ClassDetails = () => {
  ...
  const handleLeaveClass = async () => {
    ...
    try {
      ...
      toast.success("You have left the class", {
        description: "You can rejoin anytime during the scheduled period",
      });
    } catch (err) {
  ...
  return (
    <PageTransition className="bg-slate-50 pb-12">
      {loading ? (
        ...
        <>
          ...
          >
            <div className="container mx-auto px-4">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  <Badge className="mb-2">{classInfo.level}</Badge>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <SectionTransition className="lg:col-span-2" delay={0.1}>
                <Card className="mb-8">
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <ul className="space-y-2 mb-6">
                      {classInfo.topics.map((topic: string, index: number) => (
                ...
                <Card className="mb-6">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm">
                      ...
                      specializes in helping students master the speaking
                      section of language proficiency tests.
                    </p>
                  </CardContent>
                </Card>
